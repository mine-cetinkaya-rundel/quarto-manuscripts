...
-   Quarto **journal articles** (Quarto 1.2+) allow you to author journal articles with literate programming and native LaTeX templates provided by journals to create reproducible articles. **\[TO DO: Confirm version\]**
