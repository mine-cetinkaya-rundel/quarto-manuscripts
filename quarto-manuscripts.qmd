...
::: {.column width="5%"}
::: {style="text-align: center; font-size: 30px;"}
<br><br> {{< fa arrow-right >}}{{\< fa question \>}}
:::
:::
...
-   [**orchestrate** multiple inputs and outputs ]{.fragment}[**with embedded computing using a new Quarto project `type: manuscript`**]{style="color: #e0218a"}
:::
...
-   We've seen demonstrated you can *see* the code underlying the figures and tables in the manuscript

-   How about actually *touching* the code in a computational environment that's just a click away, that has all the software and packages needed to reproduce the manuscript, and that is interactive?
